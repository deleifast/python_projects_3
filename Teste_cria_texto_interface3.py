...
class exemplo:
    def __init__(self, tk):
        ...
        self.Botao1 = Button(self.frame1, text='Clique nesse botao para alterar.', command=self.alterar, bg='darkred')
        self.entrada1 = Label(self.frame2, text='Usuario:', width=8, height=2)
    ...
    def alterar(self):
        ...
        # E no frame aonde os tres acima estavam, eu coloquei esses:
        self.Botao2 = Button(self.frame3, text='Clique nesse botao para voltar.', command=self.reverter, bg='darkgray')
    ...
    def reverter(self):
        ...
        self.Botao2.pack_forget() # e "eliminei esses". Se isso nao for feito, ambos ocupam o mesmo Frame.
        self.entrada3.pack_forget() # e "eliminei esses". Se isso nao for feito, ambos ocupam o mesmo Frame.
        self.entrada4.pack_forget() # e "eliminei esses". Se isso nao for feito, ambos ocupam o mesmo Frame.
ex = Tk()
exemplo(ex)
ex.mainloop()